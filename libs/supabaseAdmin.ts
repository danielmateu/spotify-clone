...
const manageSubscription = async (subscriptionId: string, customerId: string, createAction: false) => {
    ...
    const subscriptionsData: Database["public"]["Tables"]["subscriptions"]["Insert"] = {
        id: subscription.id,
        user_id: uuid,
